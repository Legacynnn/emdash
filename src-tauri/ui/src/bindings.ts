...
export const commands = {
	 ...
	 */
	workspacesGet: (id: string) => typedError<{
	id: string,
	project_id: string,
	name: string,
	...
	created_at: string,
	updated_at: string,
} | null, WorkspacesCommandError_Serialize>(__TAURI_INVOKE("workspaces_get", { id })),
	 ...
	 */
	agentsStart: (conversationId: string, provider: AgentProvider, size: PtySize, onOutput: Channel<number[]>) => typedError<PtyId, AgentsCommandError>(__TAURI_INVOKE("agents_start", { conversationId, provider, size, onOutput })),
	agentsStop: (conversationId: string) => typedError<null, AgentsCommandError>(__TAURI_INVOKE("agents_stop", { conversationId })),
	 ...
	 */
	appLogRenderer: (level: string, message: string) => __TAURI_INVOKE<void>("app_log_renderer", { level, message }),
	/**
...
export type AgentsErrorCode = "conversation_not_found" | "workspace_not_found" | "already_running" | "spawn_failed" | "storage";
 ...
 */
{ kind: "agent_hook_event"; conversation_id: string | null; workspace_id: string | null; event: AgentEvent } | 
 ...
 */
{ kind: "agent_started"; conversation_id: string; provider: AgentProvider } | 
/**
 ...
 */
{ kind: "agent_exited"; conversation_id: string; exit_code: number | null } | 
