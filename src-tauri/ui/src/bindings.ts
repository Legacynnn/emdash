...
export const commands = {
	...
	tasksCreate: (projectId: string, name: string, sourceBranch: TaskSourceBranch, taskBranch: string | null) => typedError<Task, TasksCommandError>(__TAURI_INVOKE("tasks_create", { projectId, name, sourceBranch, taskBranch })),
	 ...
	 */
	agentsStart: (taskId: string, provider: AgentProvider, size: PtySize, onOutput: Channel<number[]>) => typedError<PtyId, AgentsCommandError>(__TAURI_INVOKE("agents_start", { taskId, provider, size, onOutput })),
	agentsStop: (taskId: string) => typedError<null, AgentsCommandError>(__TAURI_INVOKE("agents_stop", { taskId })),
	...
	tasksRename: (id: string, name: string) => typedError<Task, TasksCommandError>(__TAURI_INVOKE("tasks_rename", { id, name })),
	tasksArchive: (id: string) => typedError<Task, TasksCommandError>(__TAURI_INVOKE("tasks_archive", { id })),
	tasksRestore: (id: string) => typedError<Task, TasksCommandError>(__TAURI_INVOKE("tasks_restore", { id })),
	tasksSetPinned: (id: string, pinned: boolean) => typedError<null, TasksCommandError>(__TAURI_INVOKE("tasks_set_pinned", { id, pinned })),
	tasksUpdateLinkedIssue: (id: string, linkedIssue: string | null) => typedError<null, TasksCommandError>(__TAURI_INVOKE("tasks_update_linked_issue", { id, linkedIssue })),
	/**
	 ...
	 */
	tasksGenerateName: (description: string) => __TAURI_INVOKE<string>("tasks_generate_name", { description }),
...
export type AgentsErrorCode = "task_not_found" | "already_running" | "spawn_failed" | "storage";
...
export type TasksErrorCode = "empty_name" | "empty_branch" | "branch_already_exists" | "project_not_found" | "project_path_invalid" | "not_found" | "worktree_path_exists" | "worktree_failed" | "git" | "storage" | "malformed";
...
{ kind: "agent_started"; task_id: string; provider: AgentProvider } | 
/**
