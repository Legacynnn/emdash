...
import type {
  ...
  ConversationStore,
} from '@renderer/features/workspaces/conversations/conversation-manager';
import { DiffTabStore } from '@renderer/features/workspaces/tabs/diff-tab-store';
import { FileTabStore } from '@renderer/features/workspaces/tabs/file-tab-store';
import type { FileRendererData } from '@renderer/features/workspaces/types';
