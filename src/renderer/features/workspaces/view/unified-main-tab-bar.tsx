...
import { GitChangeStatusIcon } from '@renderer/features/workspaces/diff-view/changes-panel/components/changes-list-item';
import type {
  ResolvedConversationTab,
  ResolvedDiffTab,
  ResolvedFileTab,
} from '@renderer/features/workspaces/tabs/tab-manager-store';
import {
  useTaskViewContext,
...
export const UnifiedMainTabBar = observer(function UnifiedMainTabBar() {
  ...
  useTabShortcuts(tabManager, { focused: workspaceView.focusedRegion === 'main' });
    ...
    <div className="flex h-[41px] shrink-0 items-center justify-between border-b border-border bg-background-secondary">
      ...
      <div className="flex h-full shrink-0 items-center px-1">
        ...
        <Button
          ...
          variant="ghost"
          onClick={() =>
            showCommandPalette({ projectId, workspaceId, infraId: infraId ?? undefined })
          }
