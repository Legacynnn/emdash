...
export const TerminalsPanel = observer(function TerminalsPanel() {
  ...
  const terminalTabView = workspaceView.terminalTabs;
  ...
  const autoFocus =
    isActive && workspaceView.isTerminalDrawerOpen && workspaceView.focusedRegion === 'bottom';
  ...
  const handleCreate = async () => {
    ...
    workspaceView.setFocusedRegion('bottom');
