...
import { type LifecycleScriptsStore } from '@renderer/features/workspaces/stores/lifecycle-scripts';
import { type TerminalTabViewStore } from '@renderer/features/workspaces/terminals/terminal-tab-view-store';
