...
import { useDiffEditorComments } from '@renderer/features/workspaces/diff-view/comments/use-diff-editor-comments';
import { ImageDiffView } from '@renderer/features/workspaces/diff-view/main-panel/image-diff-view';
...
export const FileDiffView = observer(function FileDiffView() {
  ...
  const diffView = workspaceView.diffView;
  const draftComments = getWorkspaceStore(projectId, workspaceId)?.draftComments;
