...
import { getRegisteredTaskData } from '../../stores/workspace-selectors';
import {
  useTaskViewContext,
  useWorkspace,
  useWorkspaceViewModel,
} from '../../workspace-view-context';
...
export const PullRequestsSection = observer(function PullRequestsSection({
  ...
  const workspaceBranch = getRegisteredTaskData(projectId, workspaceId)?.workspaceBranch;
