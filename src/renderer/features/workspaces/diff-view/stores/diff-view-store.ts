...
import { ChangesViewStore } from '@renderer/features/workspaces/diff-view/stores/changes-view-store';
import type { PrStore } from '@renderer/features/workspaces/stores/pr-store';
