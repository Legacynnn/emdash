...
import type { DiffTabStore } from '@renderer/features/workspaces/tabs/diff-tab-store';
import type { TabManagerStore } from '@renderer/features/workspaces/tabs/tab-manager-store';
